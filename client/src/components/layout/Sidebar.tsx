...
const navigationItems = [
  ...
  { path: '/dynamic-dashboard', label: 'Dynamic Analytics', icon: BarChart3, roles: ['admin', 'researcher'], badge: 'NEW' },
  { path: '/digital-twin', label: 'Digital Twin', icon: Brain, roles: ['admin', 'researcher'], badge: 'AI' },
  { path: '/oceanographic-trends', label: 'ML Predictions', icon: Brain, roles: ['admin', 'researcher'], badge: 'ML' },
  { path: '/upload', label: 'Upload Data', icon: Upload, roles: ['admin', 'researcher'] },
  { path: '/upload-enhanced', label: 'Enhanced Upload', icon: Upload, roles: ['admin', 'researcher'], badge: 'AI' },
  { path: '/explorer', label: 'Data Explorer', icon: Search, roles: ['admin', 'researcher', 'policy_user', 'guest'] },
  { path: '/marine-map', label: 'Marine Map', icon: Search, roles: ['admin', 'researcher', 'policy_user', 'guest'], badge: 'NEW' },
  { path: '/ai-tools', label: 'AI Tools', icon: Brain, roles: ['admin', 'researcher'] },
  { path: '/ai-classifier', label: 'AI Classifier', icon: Brain, roles: ['admin', 'researcher'], badge: 'AI' },
  { path: '/fasta-analyzer', label: 'eDNA Analyzer', icon: Dna, roles: ['admin', 'researcher'], badge: 'WOW' },
  { path: '/taxonomy', label: 'Taxonomy', icon: TreePine, roles: ['admin', 'researcher', 'policy_user'] },
  { path: '/taxonomy-enhanced', label: 'Enhanced Taxonomy', icon: TreePine, roles: ['admin', 'researcher', 'policy_user'], badge: 'NEW' },
                    ...
                    <div className="relative z-10 flex items-center gap-3 flex-1">
                      ...
                      {(item as any).badge && (
                        <span className={cn(
                          ...
                          (item as any).badge === 'AI' ? "bg-purple-500/80 text-white" : "bg-green-500/80 text-white"
                        )}>
                          {(item as any).badge}
                        </span>
                      )}
